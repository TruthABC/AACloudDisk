...
//    private TextView mUploadingText;
    private WebView mUploadFileWebView;
...
//        mUploadingText = findViewById(R.id.uploading_text);
        mUploadFileWebView = findViewById(R.id.upload_file_web_view);
    }
...
//        });
    ...
    private void initFinal() {
        ...
        //set web view
        mUploadFileWebView.loadUrl(HttpUtilsHttpURLConnection.BASE_URL + "/upload_file.html");
    }
